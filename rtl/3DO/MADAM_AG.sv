...
//	                          BUS_STATE_FF == REF_WRITE0 || BUS_STATE_FF == REF_WRITE1 ||
//									  BUS_STATE_FF == REF_WRITE2 || BUS_STATE_FF == REF_WRITE3 ||
	...
	assign LCODE    =                                               SE_GRANT || EXTP_GRANT || PLAYER_GRANT ? {AG_START,AG_REF,PHASE2,AG_ACCESS&AG_WE[1]} : CPU_GRANT ? {CPU_START,1'b0,PHASE2,CPU_ACCESS&CPU_RAM_SEL&|CPU_WE[3:2]}     : 4'b0000;
	...
	assign RCODE    =                                               SE_GRANT || EXTP_GRANT || PLAYER_GRANT ? {AG_START,AG_REF,PHASE2,AG_ACCESS&AG_WE[0]} : CPU_GRANT ? {CPU_START,1'b0,PHASE2,CPU_ACCESS&CPU_RAM_SEL&|CPU_WE[1:0]}     : 4'b0000;
